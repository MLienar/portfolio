<template>
  <div class="case-page">
    ...
    <h1 class="case-title">Les écuries<br>des parots</h1>
...
export default {
  ...
  data(){
    return {
        mockup: 'mangabata',
        mockupalt: "concept app: mangabata",
        classes: "phone-case",
        mockupbrief: 'parots',
        briefalt: "site web de l'écurie des parots",
        techno1: "html",
        techno2: "css",
        techno3: "js",
    }
  ...
  mounted: function() {
    ...
    methods: {
        startAnimations: function () {
            ...
            tl.from('.fond-couleur', 0.8, {width: "100vw", height:"100vh", clipPath:"polygon(0 0, 100% 0, 100% 100%, 0 100%)"}, 0)
            tl.from('.hero-photo', 0.5, {opacity: 0, transform: "scale(1.1) translateY(-30%)"}, 0.5)
            tl.from('.case-title', 0.5, {opacity: 0, transform: "translateY(-10%)"}, 0.9)
            tl.from('.case-intro', 0.5, {opacity: 0, transform: "translateY(-10%)"}, 1.1)
        }
    },
    transition: {
    mode: 'out-in',
